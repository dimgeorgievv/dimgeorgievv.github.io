...
###### 2024:
- ***May:*** Our work *"RamanSPy: An open-source Python package for integrative Raman spectroscopy data analysis"* has been [accepted](https://pubs.acs.org/journal/ancham) to Analytical Chemistry.
